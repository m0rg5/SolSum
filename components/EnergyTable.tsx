...
const EnergyTable = ({ items, systemVoltage, highlightedId, onUpdateItem, onDeleteItem, onAddItem, onAIAddItem, onReorder, onSort, visibleCategories }) => {
    ...
    return (_jsx("div", { className: "overflow-hidden bg-slate-900 rounded-lg shadow-2xl border border-slate-800 ring-1 ring-white/5", children: _jsxs("table", { className: "w-full text-left text-[12px] text-slate-300 table-auto border-collapse", children: [_jsx("thead", { className: "bg-slate-950 text-[8px] uppercase text-slate-500 font-black tracking-widest border-b border-slate-800", children: _jsxs("tr", { children: [_jsx("th", { className: "w-6" }), _jsx(SortHeader, { label: "Item", sortKey: "name", currentSort: sortState, onSort: handleSortChange, widthClass: "min-w-[180px]" }), _jsx("th", { className: "w-6 text-center", children: "\u2713" }), _jsx("th", { className: "px-1 py-2 text-center whitespace-nowrap w-[18px]", children: "@" }), _jsx(SortHeader, { label: "POWER (W)", sortKey: "watts", currentSort: sortState, onSort: handleSortChange, className: "text-right", widthClass: "w-[50px]" }), _jsx(SortHeader, { label: "HRS/DAY", sortKey: "hours", currentSort: sortState, onSort: handleSortChange, className: "text-right", widthClass: "w-[46px]" }), _jsx("th", { className: "px-1 py-2 text-right whitespace-nowrap w-[42px]", children: "DUTY %" }), _jsx(SortHeader, { label: "DAILY WH", sortKey: "wh", currentSort: sortState, onSort: handleSortChange, className: "text-right", widthClass: "w-[45px]" }), _jsx(SortHeader, { label: "AH TOTAL", sortKey: "ah", currentSort: sortState, onSort: handleSortChange, className: "text-right", widthClass: "w-[45px]" }), _jsx("th", { className: "px-2 py-2 whitespace-nowrap uppercase", children: "Notes" }), _jsx("th", { className: "px-2 py-2 w-8" })] }) }), _jsx("tbody", { className: "divide-y divide-slate-800/50", children: sortedItems.map(item => {
                        ...
                        return (_jsxs("tr", { className: `border-b border-slate-800 hover:bg-slate-800/40 transition-all duration-700 group ${draggedId === item.id ? 'opacity-20 scale-[0.98]' : ''} ${managementItem ? 'bg-slate-900/40' : ''} ${isHighlighted ? 'bg-purple-900/40 border-purple-500/50 shadow-[inset_0_0_20px_rgba(168,85,247,0.1)] ring-1 ring-purple-500/30' : ''} ${isDisabled ? 'opacity-40 grayscale' : ''}`, draggable: true, onDragStart: (e) => {
                            ...
                            }, children: [_jsx("td", { className: "pl-2 pr-0 py-1 w-6 text-center cursor-move text-slate-700 group-hover:text-slate-400 select-none", children: "\u22EE\u22EE" }), _jsx("td", { className: "px-2 py-1 whitespace-nowrap min-w-[180px]", children: _jsx("input", { type: "text", value: item.name, onChange: (e) => onUpdateItem(item.id, 'name', e.target.value), onKeyDown: (e) => e.key === 'Enter' && e.target.blur(), className: `bg-transparent border-b border-transparent hover:border-slate-600 focus:border-blue-500 w-full text-slate-200 transition-colors text-[12px] font-medium outline-none ${managementItem ? 'italic' : ''}` }) }), _jsx("td", { className: "text-center w-6", children: _jsx("input", { type: "checkbox", checked: item.enabled !== false, onChange: (e) => onUpdateItem(item.id, 'enabled', e.target.checked), className: "rounded border-slate-700 bg-slate-800/50 text-blue-500 focus:ring-0 w-3 h-3 cursor-pointer" }) }), _jsx("td", { className: "px-1 py-1 text-right", children: showQtyInput ? (_jsx("div", { className: "inline-flex items-center justify-center w-[18px] bg-slate-850 border border-slate-700 rounded px-1 py-0.5 focus-within:border-blue-500 transition-colors", children: _jsx(NumberInput, { value: item.quantity || 1, onChange: (val) => onUpdateItem(item.id, 'quantity', Math.max(1, val)), placeholder: "1", className: "text-center pr-0" }) })) : (_jsx("div", { className: "w-[18px] h-5 flex items-center justify-center opacity-20 text-slate-600 font-mono text-[8px]", children: "-" })) }), _jsx("td", { className: "px-1 py-1 text-right", children: _jsxs("div", { className: `inline-flex items-center justify-end w-[41px] bg-slate-850 border border-slate-700 rounded px-1 py-0.5 focus-within:border-blue-500 transition-colors`, children: [_jsx(NumberInput, { value: item.watts, onChange: (val) => onUpdateItem(item.id, 'watts', val) }), _jsx("span", { className: "text-[7px] text-slate-500 font-black uppercase shrink-0", children: "W" })] }) }), _jsx("td", { className: "px-1 py-1 text-right", children: _jsxs("div", { className: `inline-flex items-center justify-end w-[36px] bg-slate-850 border border-slate-700 rounded px-1 py-0.5 focus-within:border-blue-500 transition-colors`, children: [_jsx(NumberInput, { value: item.hours, onChange: (val) => onUpdateItem(item.id, 'hours', val), step: "0.1" }), _jsx("span", { className: "text-[7px] text-slate-500 font-black uppercase shrink-0", children: "H" })] }) }), _jsx("td", { className: "px-1 py-1 text-right", children: _jsxs("div", { className: `inline-flex items-center justify-end w-[33px] bg-slate-850 border border-slate-700 rounded px-1 py-0.5 focus-within:border-blue-500 transition-colors`, children: [_jsx(NumberInput, { value: item.dutyCycle || 100, onChange: (val) => onUpdateItem(item.id, 'dutyCycle', Math.min(100, Math.max(1, val))), className: item.dutyCycle < 100 ? 'text-amber-400' : '' }), _jsx("span", { className: "text-[7px] text-slate-500 font-black uppercase shrink-0", children: "%" })] }) }), _jsx("td", { className: "px-2 py-1 text-right font-mono text-emerald-400 font-bold text-[11px] whitespace-nowrap", children: (wh || 0).toFixed(0) }), _jsx("td", { className: "px-2 py-1 text-right font-mono text-amber-400 font-bold text-[11px] whitespace-nowrap relative", children: _jsxs("div", { className: "flex items-center justify-end gap-1", children: [(ah || 0).toFixed(1), isSuspicious && _jsx("div", { className: "text-amber-500 animate-pulse", children: _jsx("svg", { viewBox: "0 0 20 20", fill: "currentColor", className: "w-3 h-3", children: _jsx("path", { fillRule: "evenodd", d: "M8.485 2.495c.673-1.167 2.357-1.167 3.03 0l6.28 10.875c.673 1.167-.17 2.625-1.516 2.625H3.72c-1.347 0-2.189-1.458-1.515-2.625L8.485 2.495ZM10 5a.75.75 0 0 1 .75.75v3.5a.75.75 0 0 1-1.5 0v-3.5A.75.75 0 0 1 10 5Zm0 9a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z", clipRule: "evenodd" }) }) })] }) }), _jsx("td", { className: "px-2 py-1 whitespace-nowrap text-[10px]", children: _jsx("input", { type: "text", value: item.notes, onChange: (e) => onUpdateItem(item.id, 'notes', e.target.value), onKeyDown: (e) => e.key === 'Enter' && e.target.blur(), className: "bg-transparent border-b border-transparent hover:border-slate-600 focus:border-blue-500 w-full text-slate-500 italic transition-colors outline-none" }) }), _jsx("td", { className: "px-2 py-1 text-center w-8", children: _jsx("button", { onClick: () => onDeleteItem(item.id), className: "text-slate-400 hover:text-red-400 opacity-60 hover:opacity-100 transition-all p-0.5 group/del", children: _jsx("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 2.5, stroke: "currentColor", className: "w-3 h-3 group-hover/del:scale-110 transition-transform", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M6 18 18 6M6 6l12 12" }) }) }) })] }, item.id));
                    }) }), _jsx("tfoot", { children: _jsx("tr", { children: _jsx("td", { colSpan: 11, className: "px-2 py-1", children: _jsxs("div", { className: "flex gap-1.5", children: [_jsx("button", { onClick: () => onAddItem(visibleCategories[0]), className: "w-[10%] flex-none flex items-center justify-center gap-2 py-1 border border-dashed border-slate-700 rounded hover:bg-slate-800 text-slate-500 text-sm font-medium transition-all", children: "+" }), _jsx("button", { onClick: () => onAIAddItem(visibleCategories[0]), className: "flex-1 flex items-center justify-center gap-2 py-1 border border-dashed border-blue-900/50 bg-blue-950/20 rounded hover:bg-blue-900/40 text-blue-400/80 text-[8px] font-black uppercase tracking-widest transition-all", children: "\u2728 Spec Asst." })] }) }) }) })] }) }));
};
