...
export const INITIAL_DATA: PowerItem[] = [
  ...
  // SYSTEM OVERHEAD
  { id: 's1', category: LoadCategory.SYSTEM_OVERHEAD, name: 'Inv1 Standby', watts: 25, hours: 2.0, dutyCycle: 100, notes: 'ON only during cooking' },
  { id: 's2', category: LoadCategory.SYSTEM_OVERHEAD, name: 'Inv2 Standby', watts: 5, hours: 10.0, dutyCycle: 100, notes: 'ON during work hours' },
  { id: 's3', category: LoadCategory.SYSTEM_OVERHEAD, name: '24-12V Converter', watts: 10, hours: 24.0, dutyCycle: 100, notes: 'Idle + Efficiency loss (Always ON)' },
  { id: 's4', category: LoadCategory.SYSTEM_OVERHEAD, name: 'IoT/HA/Shunt', watts: 5, hours: 24.0, dutyCycle: 100, notes: '24/7 Monitoring' },
];
